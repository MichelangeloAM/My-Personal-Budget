...
struct K {
    ...
    struct Generic_Text {
        static let nomeApp = "My Personal Budget"
        static let mottoApp = "Il tuo nuovo contabile, che entra in tasca!"
    ...
    struct Fbase {
        static let datiAggiornati = "Dati aggiornati con successo!"
    }
}
